...
def start():
    ...
    def doubleCheck():
        global playerPoints, robotPoints
        if playerPoints == 3 or robotPoints == 3: return True
        else: return False
    
    def win(x, y): 
        global playerPoints, robotPoints, puntosUser
        if x == "client":
    ...
    tieText = tk.Label(root, text="¡Empate!", font=("Calibri", 20), fg=tieColor)
    tieText.place(x=240, y=90)
